...
const SelectedUser = localStorage.getItem("username-ai");
const API_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/users/findProtected/${SelectedUser}`;
...
async function main() {
  ...
  const JOB_API_URL = "https://ai-api-1-4d17f0947c71.herokuapp.com/jobs";
  ...
  const EMAIL_API_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/users/${users._id}`;
  ...
  // const body = document.getElementById("body").value;
  // const user = get.localStorage(currentUser);
  const ABOUT_API_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/users/${users._id}`;
