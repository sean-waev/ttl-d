...
const LOGIN_API_URL =
  "https://ai-api-1-4d17f0947c71.herokuapp.com/auth/login";

// import 'https://tomashubelbauer.github.io/github-pages-local-storage/index.js';

async function fetchData(
  login_username = document.getElementById("username-ai").value,
  ...
  try {
    const response = await fetch(LOGIN_API_URL, {
      ...
      .then((data) => {
        ...
        localStorage.setItem("username-ai", data.username);
...
const REGISTER_API_URL =
  "https://ai-api-1-4d17f0947c71.herokuapp.com/auth/register";
