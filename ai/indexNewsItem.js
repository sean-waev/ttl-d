...
const API_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/items/${SelectedItem}`;
...
async function deleteItem(id) {
  const UPVOTE_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/items/${id}`;
  try {
...
async function deleteComment(id) {
  const UPVOTE_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/comments/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "DELETE",
      headers: {
...
async function deleteReply(id) {
  const UPVOTE_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/replies/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "DELETE",
      headers: {
...
async function UpVote(id) {
  const username = localStorage.getItem("username-ai");

  const UPVOTE_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/items/upVote/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "PUT",
      headers: {
...
async function DownVote(id) {
  ...
  const UPVOTE_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/items/downVote/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "PUT",
      headers: {
...
async function UpVoteComment(id) {
  ...
  const UPVOTE_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/comments/upVote/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "PUT",
      headers: {
...
async function DownVoteComment(id) {
  ...
  const UPVOTE_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/comments/downVote/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "PUT",
      headers: {
...
async function UpVoteReply(id) {
  ...
  const UPVOTE_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/replies/upVote/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "PUT",
      headers: {
...
async function DownVoteReply(id) {
  ...
  const UPVOTE_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/replies/downVote/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "PUT",
      headers: {
...
async function fetchReplies(itemReplies, index1) {
  const USER_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/replies/replies/findbyIds`;
  try {
    ...
    const currentUserMap = localStorage.getItem("username-ai");
...
async function fetchComments(itemComments) {
  ...
  const USER_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/comments/comments/findbyIds`;
  try {
    const response = await fetch(USER_URL, {
...
async function postComment() {
  ...
  const COMMENTS_URL =
    "https://ai-api-1-4d17f0947c71.herokuapp.com/comments";
  try {
...
async function fetchCurrentUser1() {
  const username = localStorage.getItem("username-ai");
  console.log("iran");
  const USER_URL = `https://ai-api-1-4d17f0947c71.herokuapp.com/users/findProtected/${username}`;
  try {
    const response = await fetch(USER_URL, {
      method: "GET", // or 'POST', 'PUT', 'DELETE', depending on the endpoint
      headers: {
