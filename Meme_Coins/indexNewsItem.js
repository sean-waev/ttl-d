...
const API_URL = `https://ordinals-news-api-1-a4664f788504.herokuapp.com/items/${SelectedItem}`;
...
async function deleteItem(id) {
  const UPVOTE_URL = `https://ordinals-news-api-1-a4664f788504.herokuapp.com/items/${id}`;
  try {
...
async function UpVote(id) {
  ...
  const UPVOTE_URL = `https://ordinals-news-api-1-a4664f788504.herokuapp.com/items/upVote/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "PUT",
      headers: {
...
async function DownVote(id) {
  ...
  const UPVOTE_URL = `https://ordinals-news-api-1-a4664f788504.herokuapp.com/items/downVote/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "PUT",
      headers: {
...
async function fetchComments(itemComments) {
  ...
  const USER_URL = `https://ordinals-news-api-1-a4664f788504.herokuapp.com/comments/comments/findbyIds`;
  try {
    const response = await fetch(USER_URL, {
...
async function postComment() {
  ...
  const COMMENTS_URL =
    "https://ordinals-news-api-1-a4664f788504.herokuapp.com/comments";
  try {
