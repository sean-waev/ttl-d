...
const SelectedUser = localStorage.getItem("username-nft");
const API_URL = `https://nft-news-api-1-d0f233cce385.herokuapp.com/users/findProtected/${SelectedUser}`;
...
async function main() {
  ...
  const JOB_API_URL = "https://nft-news-api-1-d0f233cce385.herokuapp.com/jobs";
  ...
  const EMAIL_API_URL = `https://nft-news-api-1-d0f233cce385.herokuapp.com/users/${users._id}`;
  ...
  // const body = document.getElementById("body").value;
  // const user = get.localStorage(currentUser);
  const ABOUT_API_URL = `https://nft-news-api-1-d0f233cce385.herokuapp.com/users/${users._id}`;
...
<br>
 <button style="margin-right:10px;" id="emailButton">Add Email</button>
  ...
  submissions.addEventListener("click", () => {
    ...
    const username1 = localStorage.getItem("username-nft");
