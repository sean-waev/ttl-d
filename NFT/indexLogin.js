...
const LOGIN_API_URL =
  "https://nft-news-api-1-d0f233cce385.herokuapp.com/auth/login";

// import 'https://tomashubelbauer.github.io/github-pages-local-storage/index.js';

async function fetchData(
  login_username = document.getElementById("username-nft").value,
  ...
  try {
    const response = await fetch(LOGIN_API_URL, {
      ...
      .then((data) => {
        ...
        localStorage.setItem("username-nft", data.username);
...
const REGISTER_API_URL =
  "https://nft-news-api-1-d0f233cce385.herokuapp.com/auth/register";
