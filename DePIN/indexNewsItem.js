...
const API_URL = `https://depin-api-1-50bbaf3a3e32.herokuapp.com/items/${SelectedItem}`;
...
async function deleteComment(id) {
  const UPVOTE_URL = `https://depin-api-1-50bbaf3a3e32.herokuapp.com/comments/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "DELETE",
      headers: {
...
async function deleteReply(id) {
  const UPVOTE_URL = `https://depin-api-1-50bbaf3a3e32.herokuapp.com/replies/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "DELETE",
      headers: {
...
async function UpVoteComment(id) {
  ...
  const UPVOTE_URL = `https://depin-api-1-50bbaf3a3e32.herokuapp.com/comments/upVote/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "PUT",
      headers: {
...
async function DownVoteComment(id) {
  ...
  const UPVOTE_URL = `https://depin-api-1-50bbaf3a3e32.herokuapp.com/comments/downVote/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "PUT",
      headers: {
...
async function UpVoteReply(id) {
  ...
  const UPVOTE_URL = `https://depin-api-1-50bbaf3a3e32.herokuapp.com/replies/upVote/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "PUT",
      headers: {
...
async function DownVoteReply(id) {
  ...
  const UPVOTE_URL = `https://depin-api-1-50bbaf3a3e32.herokuapp.com/replies/downVote/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "PUT",
      headers: {
...
async function fetchReplies(itemReplies, index1) {
  const USER_URL = `https://depin-api-1-50bbaf3a3e32.herokuapp.com/replies/replies/findbyIds`;
  try {
...
async function fetchComments(itemComments) {
  ...
  const USER_URL = `https://depin-api-1-50bbaf3a3e32.herokuapp.com/comments/comments/findbyIds`;
  try {
    const response = await fetch(USER_URL, {
...
async function postComment() {
  ...
  const COMMENTS_URL =
    "https://depin-api-1-50bbaf3a3e32.herokuapp.com/comments";
  try {
