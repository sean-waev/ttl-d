...
const LOGIN_API_URL =
  "https://desci-api-1-306c2bd8121f.herokuapp.com/auth/login";

// import 'https://tomashubelbauer.github.io/github-pages-local-storage/index.js';

async function fetchData(
  login_username = document.getElementById("username-desci").value,
  ...
  try {
    const response = await fetch(LOGIN_API_URL, {
      ...
      .then((data) => {
        ...
        localStorage.setItem("username-desci", data.username);
...
const REGISTER_API_URL =
  "https://desci-api-1-306c2bd8121f.herokuapp.com/auth/register";
