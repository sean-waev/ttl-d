...
const LOGIN_API_URL =
  "https://gaming-news-api-1-b4245f6de242.herokuapp.com/auth/login";

// import 'https://tomashubelbauer.github.io/github-pages-local-storage/index.js';

async function fetchData(
  login_username = document.getElementById("username-gaming").value,
  ...
  try {
    const response = await fetch(LOGIN_API_URL, {
      ...
      .then((data) => {
        ...
        localStorage.setItem("username-gaming", data.username);
...
const REGISTER_API_URL =
  "https://gaming-news-api-1-b4245f6de242.herokuapp.com/auth/register";
