...
const API_URL = `https://gaming-news-api-1-b4245f6de242.herokuapp.com/items/${SelectedItem}`;
...
async function deleteItem(id) {
  const UPVOTE_URL = `https://gaming-news-api-1-b4245f6de242.herokuapp.com/items/${id}`;
  try {
...
async function deleteReply(id) {
  const UPVOTE_URL = `https://gaming-news-api-1-b4245f6de242.herokuapp.com/replies/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "DELETE",
      headers: {
...
async function UpVoteReply(id) {
  ...
  const UPVOTE_URL = `https://gaming-news-api-1-b4245f6de242.herokuapp.com/replies/upVote/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "PUT",
      headers: {
...
async function DownVoteReply(id) {
  ...
  const UPVOTE_URL = `https://gaming-news-api-1-b4245f6de242.herokuapp.com/replies/downVote/${id}`;
  try {
    const response = await fetch(UPVOTE_URL, {
      method: "PUT",
      headers: {
...
async function fetchReplies(itemReplies, index1) {
  const USER_URL = `https://gaming-news-api-1-b4245f6de242.herokuapp.com/replies/replies/findbyIds`;
  try {
...
async function fetchComments(itemComments) {
  ...
  const USER_URL = `https://gaming-news-api-1-b4245f6de242.herokuapp.com/comments/comments/findbyIds`;
  try {
    const response = await fetch(USER_URL, {
...
async function postComment() {
  ...
  const COMMENTS_URL =
    "https://gaming-news-api-1-b4245f6de242.herokuapp.com/comments";
  try {
