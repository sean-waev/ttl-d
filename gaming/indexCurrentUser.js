...
const SelectedUser = localStorage.getItem("username-gaming");
...
async function main() {
  ...
  const JOB_API_URL = "https://gaming-news-api-1-b4245f6de242.herokuapp.com/jobs";
  ...
  const EMAIL_API_URL = `https://gaming-news-api-1-b4245f6de242.herokuapp.com/users/${users._id}`;
  ...
  // const body = document.getElementById("body").value;
  // const user = get.localStorage(currentUser);
  const ABOUT_API_URL = `https://gaming-news-api-1-b4245f6de242.herokuapp.com/users/${users._id}`;
...
<br>
 <button style="margin-right:10px;" id="emailButton">Add Email</button>
  ...
  submissions.addEventListener("click", () => {
    ...
    const username1 = localStorage.getItem("username-gaming");
