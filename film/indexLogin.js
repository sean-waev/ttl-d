...
const LOGIN_API_URL =
  "https://film-news-api-1-7b08fa68da7b.herokuapp.com/auth/login";

// import 'https://tomashubelbauer.github.io/github-pages-local-storage/index.js';

async function fetchData(
  login_username = document.getElementById("username-film").value,
  ...
  try {
    const response = await fetch(LOGIN_API_URL, {
      ...
      .then((data) => {
        ...
        localStorage.setItem("username-film", data.username);
...
const REGISTER_API_URL =
  "https://film-news-api-1-7b08fa68da7b.herokuapp.com/auth/register";
