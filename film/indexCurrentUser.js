...
const SelectedUser = localStorage.getItem("username-film");
const API_URL = `https://film-news-api-1-7b08fa68da7b.herokuapp.com/users/findProtected/${SelectedUser}`;
...
async function main() {
  ...
  const JOB_API_URL = "https://film-news-api-1-7b08fa68da7b.herokuapp.com/jobs";
  ...
  const EMAIL_API_URL = `https://film-news-api-1-7b08fa68da7b.herokuapp.com/users/${users._id}`;
  ...
  // const body = document.getElementById("body").value;
  // const user = get.localStorage(currentUser);
  const ABOUT_API_URL = `https://film-news-api-1-7b08fa68da7b.herokuapp.com/users/${users._id}`;
...
<br>
 <button style="margin-right:10px;" id="emailButton">Add Email</button>
  ...
  submissions.addEventListener("click", () => {
    ...
    const username1 = localStorage.getItem("username-film");
