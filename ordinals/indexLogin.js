...
const LOGIN_API_URL =
  "https://ordinals-news-api-1-a4664f788504.herokuapp.com/auth/login";

// import 'https://tomashubelbauer.github.io/github-pages-local-storage/index.js';

async function fetchData(
  login_username = document.getElementById("username-ordinals").value,
  ...
  try {
    const response = await fetch(LOGIN_API_URL, {
      ...
      .then((data) => {
        ...
        localStorage.setItem("username-ordinals", data.username);
...
const REGISTER_API_URL =
  "https://ordinals-news-api-1-a4664f788504.herokuapp.com/auth/register";
